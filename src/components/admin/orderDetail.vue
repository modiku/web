<template>
    ...
    <el-descriptions title="用户信息" :column="2" style="width: 700px;margin: auto; margin-top: 20px;"
            border>
    ...
    <div class="order-container">
        <el-table :data="productList" border style="width: 580px" class="table">
        ...
        <div class="button-area">
            <el-button type="danger" round v-if="!order.pay" disabled>未支付</el-button>
            <el-button type="success" round v-if="order.pay" disabled>已支付</el-button>

            <el-button link :disabled="order.pay" @click="del">删除订单</el-button>
